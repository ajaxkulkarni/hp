...
public interface Constants {
	...
	String BLOG_2_PAGE = "blog_two";
	String BLOG_1_PAGE = "blog_one";
	String BLOG2_GET_URL = "BloodGroup.htm";
	String BLOG1_GET_URL = "PathologyTest.htm";
	String OFFER_PAGE = "offerPage";
	String Offer_GET_URL = "OfferPage.htm";
	...
	String MAIL_TYPE_LAB_PARTNER = "labPartner";
	String MAIL_TYPE_LAB_PARTNER_ADMIN = "labPartnerAdmin";

	String[] ADMIN_MAIL_TYPES = { MAIL_TYPE_REQUEST_CHECKUP_LAB, MAIL_TYPE_REQUEST_CALLBACK_LAB, MAIL_TYPE_CORPORATE_REQUEST_ADMIN, MAIL_TYPE_CORPORATE_PARTNER_ADMIN, MAIL_TYPE_LAB_PARTNER_ADMIN };
	...
	String[] OPEN_URLS = {SUPPORT_GET_URL, PRICING_GET_URL, GET_PRICING_POST_URL, PRIVACY_GET_URL, TERMS_GET_URL, 
			...
			REQUEST_CALL_BACK_POST_URL, REQUEST_CHECK_UP_POST_URL, GET_TEST_DETAILS_POST_URL, CORPORATE_PARTNER_GET_URL, 
			REQUEST_CORPORATE_PARTNER_POST_URL, LAB_PARTNER_GET_URL, REQUEST_LAB_PARTNER_POST_URL, "sitemap.xml", BLOG1_GET_URL, BLOG2_GET_URL, Offer_GET_URL};
	String[] CC_ALLOWED_URLS = {ADMIN_HOME_GET_URL, ADMIN_HOME_PENDING_APPS_URL_GET, ADMIN_HOME_CANCELLED_URL_GET, ADMIN_HOME_TOTAL_URL_GET
			, ADMIN_CORPORATE_GET_URL, ADMIN_CANCEL_APPOINTMENT_POST_URL, ADMIN_DOWNLOAD_EXCEL_GET_URL, ADMIN_GET_APPOINTMENTS_FOR_DATES_POST_URL, ADMIN_CORPORATE_BOOK_APPOINTMENT_POST_URL};
