                    ...
                    <div class="col-xs-12 col-xs-12 col-md-12 col-lg-12 col-xl-12">
                        ...
                        <nav class="navbar navbar-default navbar-static-top classCustomNavBar" role="navigation" style="margin-bottom: 0">
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="#"><img src="<c:url value="/resources/images/ie_logo.png"/>" class="classLogoImg"/></a>
                            </div>
                                                        <!-- /.navbar-header -->
                                      ...
                                      <a class="dropdown-toggle"  href="#">
                                        ...
                                        <c:choose>
                                     			<c:when test="${user.firstName == null }">
                                     				 <a  href="#" ><i class="fa fa-user fa-fw"></i> Sign Up </a> 	
                                     			</c:when>
                                     			<c:otherwise>
                                     			 	<a  href="#" ><i class="fa fa-user fa-fw"></i> ${user.firstName} </a> 
                                     			</c:otherwise>
                                     		</c:choose>
                                        </li>                                        
