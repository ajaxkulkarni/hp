                                                            ...
                                                            <div class="well order-detail-well">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12 col-xs-12 m-t-10">
                                                                        ...
                                                                        <a href="<%=Constants.LAB_COMPLETE_APPOINTMENT_GET_URL %>?id=${appointment.id}"  ><button style="text-transform:capitalize;" class="btn btn-sm btn-default">Complete</button></a>
